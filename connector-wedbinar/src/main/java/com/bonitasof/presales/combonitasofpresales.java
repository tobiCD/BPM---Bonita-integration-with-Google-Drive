package .com.bonitasof.presales;
...
public class combonitasofpresales extends AbstractConnector {

    private static final Logger LOGGER = Logger.getLogger(combonitasofpresales.class.getName());

    static final String DEFAULT_INPUT = "defaultInput";
    static final String DEFAULT_OUTPUT = "defaultOutput";

    /**
     * Perform validation on the inputs defined on the connector definition (src/main/resources/connector-wedbinar.def)
     * You should: 
