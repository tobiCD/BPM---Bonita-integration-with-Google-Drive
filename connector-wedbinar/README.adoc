...
:short-bonita-version: com.bonitasoft
:doc-url: https://documentation.bonitasoft.com/bonita/{short-bonita-version}
:java-version: 17
= connector-wedbinar

The project **connector-wedbinar** is a Bonita Connector for **Bonita {short-bonita-version}**  **Community** version written in `java` language.
...
[source,bash]
----
git clone https://your.github.com/connector-wedbinar.git
cd connector-wedbinar/
./mwnw package
----

The build should produce a jar archive under the `target/` folder named `connector-wedbinar-1.0-SNAPSHOT.jar`
